...
#sometimes will run this on the original data, here run on the detrended
#dummies
...
beta_coef <- seas_means_model$coefficients[2:12] #vector because we have one coefficient for each month

#compute seasonal component
season_inflow_data <- array(0,nobs)
for (i in 1:nobs){
  season_inflow_data[1] <- beta_int+beta_coef%*%dummies[i,]
}
