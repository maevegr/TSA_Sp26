...
```{r}
#Z automatically fits as additive or multiplicative
...
```{r}
#let the model choose variance values with NA
#see seasonality in ACF plot for residuals
...
```{r}
SS_seas <- StructTS(ts_price_train ,
                    type="BSM",fixed=c(0.1,0.01,0.3,NA)) #manually adjust the coefficients until you pass the residuals check
