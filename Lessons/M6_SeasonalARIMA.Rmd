...
SARIMA1 <- Arima(ts_electricity_price[,"Residential"], order = c(1,1,1), seasonal=c(0,1,1))
print(SARIMA1)

SARIMA2 <- Arima(ts_electricity_price[,"Residential"], order = c(0,1,1), seasonal=c(0,1,1))
print(SARIMA2)

SARIMA3 <- Arima(residential_price_both_diff, order = c(0,1,0), seasonal=c(0,1,1))
print(SARIMA3)
```
...
autofit <- auto.arima(ts_electricity_price[,"Residential"], approximation = TRUE)
