...
plot(naive_seas)
#assumes that whatever happened in the past will repeast in the future

#Model 4: Naive on deseas data
naive_deseas <- snaive(deseasonal_allsectors_price, h=36)
plot(naive_deseas)
